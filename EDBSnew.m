%Function to perform Efficient Direct Binary search halftoning
%%   Author: 
...
%%im=input gray scale image; dst= output halftone image

function [dst]=EDBSnew(im)
im=double(im);

%Initiation
[rows cols]=size(im);

%Random Initialisation of Halftone Image
